					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:150px;"><img src="<?php echo htmlspecialchars(get_admin_image_url($row['photo']), ENT_QUOTES); ?>" alt="<?php echo htmlspecialchars($row['heading'], ENT_QUOTES); ?>" style="width:140px;"></td>
