...
if (!function_exists('store_migrate_all_tables')) {
    function store_migrate_all_tables(PDO $pdo): void { StoreRepository::migrateTables($pdo); }
}

if (!function_exists('store_get')) {
    function store_get(PDO $pdo, int $id): ?array { return StoreRepository::get($pdo, $id); }
}

if (!function_exists('store_get_by_slug')) {
    function store_get_by_slug(PDO $pdo, string $slug): ?array { return StoreRepository::getBySlug($pdo, $slug); }
}

if (!function_exists('store_get_by_domain')) {
    function store_get_by_domain(PDO $pdo, string $domain): ?array { return StoreRepository::getByDomain($pdo, $domain); }
}
...
if (!function_exists('store_create')) {
    function store_create(PDO $pdo, array $data): int { return StoreRepository::create($pdo, $data); }
}

if (!function_exists('store_update')) {
    function store_update(PDO $pdo, int $id, array $data): void { StoreRepository::update($pdo, $id, $data); }
}

if (!function_exists('store_delete')) {
    function store_delete(PDO $pdo, int $id): void { StoreRepository::delete($pdo, $id); }
}
...
if (!function_exists('store_set_current_id')) {
    function store_set_current_id(?int $id): void { StoreService::setCurrentId($id); }
}

if (!function_exists('store_current_id')) {
    function store_current_id(): ?int { return StoreService::getCurrentId(); }
}

if (!function_exists('store_resolve')) {
    function store_resolve(PDO $pdo): int { return StoreService::resolve($pdo); }
}
...
if (!function_exists('store_get_store_users')) {
    function store_get_store_users(PDO $pdo, int $storeId): array { return StoreService::getUsers($pdo, $storeId); }
}
...
if (!function_exists('store_get_stats')) {
    function store_get_stats(PDO $pdo, int $storeId): array { return StoreService::getStats($pdo, $storeId); }
}

if (!function_exists('store_get_global_stats')) {
    function store_get_global_stats(PDO $pdo): array { return StoreService::getGlobalStats($pdo); }
}

if (!function_exists('store_get_theme')) {
    function store_get_theme(PDO $pdo, int $storeId): ?array { return StoreService::getTheme($pdo, $storeId); }
}
...
if (!function_exists('store_generate_slug')) {
    function store_generate_slug(string $name): string { return Helpers::generateSlug($name); }
}
...
if (!function_exists('store_get_subscription')) {
    function store_get_subscription(PDO $pdo, int $storeId): ?array { return StoreSubscription::get($pdo, $storeId); }
}
...
if (!function_exists('store_get_monthly_usage')) {
    function store_get_monthly_usage(PDO $pdo, int $store_id, ?string $month = null): array
    {
        ...
        $stmt = $pdo->prepare("SELECT * FROM tbl_store_usage WHERE store_id = ? AND month_year = ? LIMIT 1");
...
if (!function_exists('store_ensure_usage_row')) {
    ...
    {
        $stmt = $pdo->prepare("INSERT IGNORE INTO tbl_store_usage (store_id, month_year) VALUES (?, ?)");
        $stmt->execute([$store_id, $month]);
    }
}
...
if (!function_exists('store_track_usage')) {
    function store_track_usage(PDO $pdo, int $store_id, string $metric, int $increment = 1): void
    {
        ...
        $stmt = $pdo->prepare("UPDATE tbl_store_usage SET `$column` = `$column` + ? WHERE store_id = ? AND month_year = ?");
...
if (!function_exists('store_check_order_quota')) {
    function store_check_order_quota(PDO $pdo, int $store_id): array { return store_check_quota($pdo, $store_id, 'order'); }
}
...
if (!function_exists('store_dequeue_job')) {
    function store_dequeue_job(PDO $pdo, string $type): ?array { return QueueService::dequeue($pdo, $type); }
}
...
if (!function_exists('store_get_queue_stats')) {
    function store_get_queue_stats(PDO $pdo): array { return QueueService::getStats($pdo); }
}
...
if (!function_exists('store_get_job')) {
    function store_get_job(PDO $pdo, int $jobId): ?array { return QueueService::getJob($pdo, $jobId); }
}

if (!function_exists('store_retry_job')) {
    function store_retry_job(PDO $pdo, int $jobId): void { QueueService::retry($pdo, $jobId); }
}

if (!function_exists('store_cancel_job')) {
    function store_cancel_job(PDO $pdo, int $jobId): void { QueueService::cancel($pdo, $jobId); }
}
...
if (!function_exists('store_get_failed_job_count')) {
    function store_get_failed_job_count(PDO $pdo): int { return QueueService::getFailedJobCount($pdo); }
}
...
if (!function_exists('store_process_job')) {
    function store_process_job(PDO $pdo, array $job): array { return QueueWorker::processJob($pdo, $job); }
}

if (!function_exists('store_get_backoff_minutes')) {
    function store_get_backoff_minutes(int $attempt): int { return QueueWorker::getBackoffMinutes($attempt); }
}

if (!function_exists('store_get_job_types_list')) {
    function store_get_job_types_list(): array { return QueueWorker::getJobTypes(); }
}

if (!function_exists('store_get_priority_list')) {
    function store_get_priority_list(): array { return QueueWorker::getPriorities(); }
}

if (!function_exists('store_bulk_enqueue')) {
    function store_bulk_enqueue(PDO $pdo, array $jobs): int { return QueueService::bulkEnqueue($pdo, $jobs); }
}

if (!function_exists('store_requeue_failed_jobs')) {
    function store_requeue_failed_jobs(PDO $pdo): int { return QueueService::requeueFailedJobs($pdo); }
}
...
if (!function_exists('store_get_queue_health')) {
    function store_get_queue_health(PDO $pdo): array { return QueueHealth::getHealth($pdo); }
}

if (!function_exists('store_get_queue_avg_processing_time')) {
    function store_get_queue_avg_processing_time(PDO $pdo): float { return QueueHealth::getAvgProcessingTime($pdo); }
}
...
if (!function_exists('store_get_backup_job')) {
    function store_get_backup_job(PDO $pdo, int $backupId): ?array { return BackupService::getJob($pdo, $backupId); }
}
...
if (!function_exists('store_delete_backup_job')) {
    function store_delete_backup_job(PDO $pdo, int $backupId): void { BackupService::deleteJob($pdo, $backupId); }
}
...
if (!function_exists('store_get_all_backup_configs')) {
    function store_get_all_backup_configs(PDO $pdo): array { return BackupService::getAllConfigs($pdo); }
}

if (!function_exists('store_get_backup_storage_path')) {
    function store_get_backup_storage_path(): string { return BackupService::getStoragePath(); }
}
...
if (!function_exists('store_get_backup_logs')) {
    function store_get_backup_logs(PDO $pdo, int $backupId): array { return BackupService::getLogs($pdo, $backupId); }
}
...
if (!function_exists('store_backup_upload_s3')) {
    function store_backup_upload_s3(PDO $pdo, int $backupId): bool { return BackupService::uploadToS3($pdo, $backupId); }
}

if (!function_exists('store_apply_retention_policy')) {
    function store_apply_retention_policy(PDO $pdo): int { return RetentionService::apply($pdo); }
}
...
if (!function_exists('store_get_backup_health')) {
    function store_get_backup_health(PDO $pdo): array { return BackupService::getHealth($pdo); }
}

if (!function_exists('store_check_backup_alerts')) {
    function store_check_backup_alerts(PDO $pdo): array { return BackupService::checkAlerts($pdo); }
}

if (!function_exists('store_get_backup_type_labels')) {
    function store_get_backup_type_labels(): array { return BackupService::getTypeLabels(); }
}

if (!function_exists('store_get_backup_scope_labels')) {
    function store_get_backup_scope_labels(): array { return BackupService::getScopeLabels(); }
}

if (!function_exists('store_get_backup_status_labels')) {
    function store_get_backup_status_labels(): array { return BackupService::getStatusLabels(); }
}

if (!function_exists('store_backup_download')) {
    function store_backup_download(PDO $pdo, int $backupId): ?string { return BackupService::download($pdo, $backupId); }
}

if (!function_exists('store_get_backup_storage_summary')) {
    function store_get_backup_storage_summary(PDO $pdo): array { return BackupService::getStorageSummary($pdo); }
}
...
if (!function_exists('store_generate_api_key')) {
    function store_generate_api_key(): string { return ApiKeyService::generateKey(); }
}
...
if (!function_exists('store_get_api_keys')) {
    function store_get_api_keys(PDO $pdo, int $storeId): array { return ApiKeyService::getKeys($pdo, $storeId); }
}
...
if (!function_exists('store_validate_api_key')) {
    function store_validate_api_key(PDO $pdo, string $apiKey): ?array { return ApiKeyService::validate($pdo, $apiKey); }
}
...
if (!function_exists('store_get_available_permissions')) {
    function store_get_available_permissions(): array { return ApiKeyService::getAvailablePermissions(); }
}
...
if (!function_exists('store_get_webhooks')) {
    function store_get_webhooks(PDO $pdo, int $storeId): array { return WebhookService::getWebhooks($pdo, $storeId); }
}
...
if (!function_exists('store_get_webhook_events_list')) {
    function store_get_webhook_events_list(): array { return WebhookService::getEventsList(); }
}
...
if (!function_exists('store_get_rate_limit')) {
    function store_get_rate_limit(PDO $pdo, int $storeId): array { return RateLimitService::getLimit($pdo, $storeId); }
}
...
if (!function_exists('store_format_bytes')) {
    function store_format_bytes(int $bytes): string { return Helpers::formatBytes($bytes); }
}
