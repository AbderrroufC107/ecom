...
<section class="content orders-page">
    <div id="orders-react-root"
        data-total="<?php echo (int) $summary['total']; ?>"
        data-today="<?php echo (int) $summary['today']; ?>"
        data-pending="<?php echo (int) $summary['pending']; ?>"
        data-pending-no-calls="<?php echo (int) $summary['pending_no_calls']; ?>"
        data-pending-ready="<?php echo (int) $summary['pending_ready']; ?>"
        data-pending-followup="<?php echo (int) $summary['pending_followup']; ?>"
        data-completed-amount="<?php echo htmlspecialchars(admin_format_order_amount($summary['completed_amount']), ENT_QUOTES, 'UTF-8'); ?>"></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($order['assigned_employee_name'])): ?>
                                                    <span class="pill is-registered" style="background:#e0f2fe;color:#0369a1;font-size:12px;display:inline-block;padding:3px 10px;border-radius:999px;font-weight:700;">
                                                        <i class="fa fa-user-circle-o" style="margin-left:4px;"></i><?php echo htmlspecialchars($order['assigned_employee_name'], ENT_QUOTES, 'UTF-8'); ?>
                                                    </span>
                                                <?php else: ?>
                                                    <span class="pill is-other" style="font-size:12px;color:#94a3b8;">غير موزع</span>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="row-actions">
                                                    <a href="order-details.php?id=<?php echo $order_id; ?>#tab_summary" class="btn btn-info btn-xs"><i class="fa fa-address-card-o"></i> التفاصيل والتعديل</a>
