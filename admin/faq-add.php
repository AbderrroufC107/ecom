				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="faq_title" value="<?php if(isset($_POST['faq_title'])){echo htmlspecialchars($_POST['faq_title'], ENT_QUOTES, 'UTF-8');} ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Content <span>*</span></label>
							<div class="col-sm-9">
								<textarea class="form-control" name="faq_content" id="editor1" style="height:200px;"><?php if(isset($_POST['faq_content'])){echo htmlspecialchars($_POST['faq_content'], ENT_QUOTES, 'UTF-8');} ?></textarea>
							</div>
						</div>
						<div class="form-group">
