				...
				<div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							<?php
							$i=0;
							$statement = $dbRepo->prepare("SELECT * FROM tbl_service");
							$statement->execute();
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:130px;"><img src="<?php echo htmlspecialchars(get_admin_image_url($row['photo']), ENT_QUOTES); ?>" alt="<?php echo htmlspecialchars($row['title'], ENT_QUOTES); ?>" style="width:120px;"></td>
