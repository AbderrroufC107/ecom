...
$statement = $pdo->prepare("SELECT e.ecat_id
...
$pdo->prepare("DELETE FROM tbl_mid_category WHERE tcat_id=?")->execute([$top_id]);
$pdo->prepare("DELETE FROM tbl_top_category WHERE tcat_id=?")->execute([$top_id]);
