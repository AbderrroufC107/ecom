    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="orders-page"><div class="table-responsive">
...
// Since whitespace may differ, we can do this using strpos
// Actually, let's find the position of '<div class="box-body">' around line 703 and replace until '$total_profit ='

$regex = '/<div class="box-body">\s*\$total_profit = \$order\[\'quantity\'\] \* \$profit_per_unit;/';

if (preg_match($regex, $content)) {
    $content = preg_replace($regex, $good_block, $content);
    file_put_contents($file, $content);
    echo "Fixed using regex!";
} else {
