...
$banner_reset_password_url = trim((string)get_front_image_url($banner_reset_password));
?>
...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement->execute(array(password_hash($cust_new_password, PASSWORD_DEFAULT),'','',$_GET['email']));
...
<div class="page-banner" style="background-color:#444;<?php if ($banner_reset_password_url !== ''): ?>background-image: url('<?php echo htmlspecialchars($banner_reset_password_url, ENT_QUOTES, 'UTF-8'); ?>');<?php endif; ?>">
    <div class="inner">
